...
const Footer = () => {
  return (
    <div className="fixed bottom-1 left-0 w-full">
      ...
      <div
        className="text-sm text-center md:px-10 md:py-4 py-2 bg-[#27321e] rounded-lg bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-gray-100
"
      >
        <h1>
          ...
          <span className="md:mx-5 mx-1">All Rights are reserved</span>@HarshRajKumar{" "}
          <span className="md:mx-5 mx-1">
            {<FontAwesomeIcon icon={faCopyright} inverse />}
          </span>
