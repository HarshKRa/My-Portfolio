  ...
  return (
    <>
      <header>
        ...
        <div className="w-11/12 md:rounded-lg md:flex items-center justify-between m-auto md:px-10 px-5 md:mt-1 bg-gray-600 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 border border-gray-100
">
    { /*   <div className=" md:w-11/12 md:rounded-3xl md:flex items-center border-white border-2 rounded-lg justify-between m-auto md:px-10 px-5 md:mt-5 bg-[#1b2029]"> */}
          ...
          <nav className="">
            ...
            <ul
              className={`md:flex md:pb-0 pb-7 absolute md:static md:z-auto z-[2] md:bg-transparent bg-[#303B4B] /*bgColor*/ left-0 w-full  md:w-auto md:pl-0 pl-9 trasition-all duration-500 ${
                open ? "top-19 border-white border-2 rounded-lg" : "top-[-500px]"
              }`}
            >
              {Links.map((link) => (
